...
\end{align*}
We use the Taylor series expansion of $f(\cdots)$ around the point $(X_t, t)$.  For a function of two variables, the Taylor expansion to the second order, ignoring the higher-order derivatives
\begin{align*}
