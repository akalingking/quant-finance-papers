...
The \textbf{Milstein} \cite{wiki:milstein-method} method improves the Euler-Maruyama approximation by adding the second-order term from the Ito-Taylor expansion. This increases the strong convergence order from $0.5$ to $1.0$.
\\
\\
...
\begin{figure}[h!]
    \centering    \includegraphics[width=0.5\textwidth]{figures/milstein_strong_convergence.pdf}
    \vspace{-25pt}
