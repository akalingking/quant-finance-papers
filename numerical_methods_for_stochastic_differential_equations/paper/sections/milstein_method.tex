...
\begin{figure}[h!]
    \centering    \includegraphics[width=0.5\textwidth]{figures/milstein_strong_convergence.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/milstein_weak_convergence.png}
